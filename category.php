...
<body>
	...
	<header id="header">
		...
		<div class="page-header">
			<div class="page-header-bg" style="background-image: url('<?php echo $row['image']?>');background-repeat: no-repeat;background-size: cover;" data-stellar-background-ratio="0.5"></div>
			<div class="container">
				<div class="row">
			...
			<div class="row">
				<div class="col-md-8">
                    ...
                    <?php
						...
						$stmt_2->execute();
						#while($row_1 = mysqli_fetch_array($query_1))
						$row_2 = $stmt_2->fetch(PDO::FETCH_BOTH);
                    ?>
					<div class="post post-thumb">
                        <a class="post-img" href="
                        <?php
                            $cId = $row_2['categoryID'];
                            $pId = $row_2['postID'];
                            #$c_query = mysqli_query($dbconfig, "SELECT name FROM category WHERE id='$cId'");
                            $c_sql = "SELECT name FROM category WHERE id='$cId'";
                            $stmt_3 = $conn->prepare($c_sql);
                            $stmt_3->execute();
                            #$rows = mysqli_fetch_array($c_query);
                            $rows = $stmt_3->fetch(PDO::FETCH_BOTH);
                            echo "blog-post.php?posts=$pId;"
                        ?>
                        ">
                            
                        <img src="<?php echo $row_2['image']?>" alt=""></a>
						<div class="post-body">
							<div class="post-category">
								<a href="<?php echo "category.php?category=$cId";?>"><?php echo $row['name']?></a>	
							</div>
							<h3 class="post-title title-lg"><a href="<?php echo "blog-post.php?posts=$pId"?>"><?php echo $row_2['title']?></a></h3>
							<ul class="post-meta">
								<li><a href="author.html"><?php echo $row_2['author']?></a></li>
								<li><?php echo $row_2['postDate']?></li>
							</ul>
                        </div>
					...
					<div class="row">
                        ...
                        <?php
                            ...
                            #while($row_1 = mysqli_fetch_array($query_1))
                            while($row_3 = $stmt_4->fetch(PDO::FETCH_BOTH)){
						...
						<div class="col-md-6">
							<div class="post">
                                <a class="post-img" href="
                                    <?php
                                        $cId_1 = $row_3['categoryID'];
                                        $pId_1 = $row_3['postID'];
                                        #$c_query = mysqli_query($dbconfig, "SELECT name FROM category WHERE id='$cId'");
                                        $c_sql = "SELECT name FROM category WHERE id='$cId_1'";
                                        $stmt_5 = $conn->prepare($c_sql);
                                        $stmt_5->execute();
                                        #$rows = mysqli_fetch_array($c_query);
                                        $rows_1 = $stmt_5->fetch(PDO::FETCH_BOTH);
                                        echo "blog-post.php?posts=$pId_1";
                                    ?>    
                                "><img src="<?php echo $row_3['image']?>" alt=""></a>
								<div class="post-body">
									<div class="post-category">
                                        <a href="
                                        <?php
                                            
                                            echo "category.php?category=$cId_1";
                                        ?>
                                        "><?php echo $rows_1['name']?></a>
									</div>
									<h3 class="post-title"><a href="<?php echo "blog-post.php?posts=$pId_1"?>"><?php echo $row_3['title']?></a></h3>
									<ul class="post-meta">
										<li><a href="author.html"><?php echo $row_3['author']?></a></li>
										<li><?php echo $row_3['postDate']?></li>
									</ul>
								</div>
							</div>
                        </div>
